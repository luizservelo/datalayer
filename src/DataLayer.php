...
namespace Wallygator\DataLayer;
...
abstract class DataLayer
{
    ...
    /** @var bool $primaryUUID when your primary key is an UUIDv4 string - varchar(36) */
    private $primaryUUID;
     ...
     * @param bool $primaryUUID
     */
    public function __construct(string $entity, array $required, string $primary = 'id', bool $timestamps = true, bool $primaryUUID = false)
    {
        $this->entity = $entity;
    ...
    */
     ...
     */
    public function findById($id, string $columns = "*"): ?DataLayer
    {
